...
import (
	...
	"github.com/StyraInc/terraform-provider-styra/internal/sdk/retry"
	"net/http"
	"time"
)
...
func New(opts ...SDKOption) *StyraDas {
	sdk := &StyraDas{
		sdkConfiguration: sdkConfiguration{
			...
			SDKVersion:        "0.0.1",
			GenVersion:        "2.404.10",
			UserAgent:         "speakeasy-sdk/go 0.0.1 2.404.10 2.0.0 github.com/StyraInc/terraform-provider-styra/internal/sdk",
			ServerDefaults: []map[string]string{
				{},
				{
					"dasId": "example",
	...
	sdk.Authz = newAuthz(sdk.sdkConfiguration)
